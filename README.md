...
```bash
uv tool install specify-cli --from git+https://github.com/kuochunchang/spec-kit.git
```
...
```bash
uvx --from git+https://github.com/kuochunchang/spec-kit.git specify init <PROJECT_NAME>
```
